...
class Tree:
    ...
    def branching_factor(self) -> float:
        ...
        if self.is_empty():
            return 0.0
        count, branches = self._branching_factor_helper()
        ...
        if self.is_empty():
            ...
            for subtree in self._subtrees:
                if subtree._subtrees:
                    new_nodes, new_branches = subtree._branching_factor_helper()
                    num_nodes += new_nodes
                    branches += new_branches
            return num_nodes, branches
    ...
    def insert(self, item: Any) -> None:
        ...
        >>> 1 in t
        True
        >>> lt = Tree(2, [Tree(4, [], 1), Tree(5, [], 1)], 3)
        >>> rt = Tree(3, [Tree(6, [], 1), Tree(7, [], 1), Tree(8, [], 1), Tree(9, [], 1),\
                          Tree(10, [], 1)], 6)
        >>> t = Tree(1, [lt, rt], 10)
        >>> t.insert(100)
        >>> 100 in t
